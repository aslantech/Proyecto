...
if(isset($_POST["crear"]))
{
          ...
          if($suma>0) {
            ...
            echo '<div class="form-box">
                        <div class="alert alert-success alert-dismissable">
                                        <i class="fa fa-check"></i>
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                        <b>Registro !</b>  Bienvenido, ya Puedes Ingresa al sistema.
                                    </div>
                                </div>';
    ...
    if(isset($_POST["correo"])){
                ...
                if ($mostrar = $bd->mostrar_registros()) {
                    ...
                    $correozippy="kapeate@gmail.com";
            
                    $casilla = 'ernespee@gmail.com';
                    $asunto = '';
                    ...
                    if($bool){
                        echo '<div class="form-box">
                                    <div class="alert alert-success alert-dismissable">
                                        <i class="fa fa-check"></i>
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                        <b>Recuperar Contraseña !</b>Puedes revisar tu correo por favor 
                                    </div>
                                </div>';
                    }
                    else{
        ...
        if ($temp_resg = $bd->mostrar_registros()) {
            ...
            echo '<div class="form-box">
                        <div class="alert alert-success alert-dismissable">
                                        <i class="fa fa-check"></i>
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                        <b>Registro !</b>  Muy bien, Ingresa al sistema.
                                    </div>
                                </div>';
        }else{
         ...
         <div class="content col-md-4 ">
            ...
            <form  name="frmLogin" class="login-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix input-circle2" type="text"  placeholder="Email" name="usuario" /> 
                ...
                <div class="form-actions">
                    <button type="submit"  class="btn blue uppercase">Ingresar</button>
                    </br>
                    </br>
            ...
            <form class="forget-form" action="" method="post">
                <h3 class="font-green">¿Contraseña no recuerdo?</h3>
                <p>Ingrese su correo.</p>
                <div class="form-group">
                    <input class="form-control placeholder-no-fix input-circle2" type="email" required autocomplete="off"   placeholder="ingresar email" name="email" />
                     </div>
                <div class="form-actions">
                    <button type="button" id="back-btn" class="btn btn-default">Atras</button>
                   
                     <button type="submit"  name="correo" id="register-submit-btn" class="btn blue uppercase pull-right">Enviar</button>
                </div>
            </form>
            ...
            <div id="Info"></div>
               ...
               <label class="control-label visible-ie8 visible-ie9">N° De Identificacion</label>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit"  name="crear" id="register-submit-btn" class="btn blue uppercase pull-right">Registrar</button>
                </div>
            </form>
