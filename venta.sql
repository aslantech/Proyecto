...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-10-2017 a las 02:30:20
...
(10, 'sierra Ernesto', 'Ahorro', '02020202', 'casa principal', 'v-2000000', 'estefanyernes@gmail.com', 1),
(11, 'Ernesto sierra', 'otro', '', 'mi casa', '01010101', 'ernespee@gmail.com', 1);
...
(1, 'Ernesto', 'sierra', 'ernespee@gmail.com', 1, '123');
...
(1, 'Compucenter', '0276-3480995', 'j-21545412-0', 'centro calle 12', 1, 'logoc3.png');
...
(54, 'maus', 1300, '0000-00-00 00:00:00', 'mejora su visualizacion', 3, '2017-10-22 00:10:50', 'servicio ', 'producto_heavydeveloperstext.pngsistemaphp', 1200, 0);
...
--
ALTER TABLE `movimientosaldo`
  MODIFY `id_msaldo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
